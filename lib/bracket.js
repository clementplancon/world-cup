...
async function fetchAndBuildBracket({ apiKey, previousData = null } = {}) {
  ...
  if (previousData && !isInsideAMatchWindow()) {
    // Outside any match window and we already have a bracket to serve: skip the
    // API call to stay well under the rate limit.
    return null;
  }
